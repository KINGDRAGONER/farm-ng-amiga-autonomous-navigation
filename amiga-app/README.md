...
## Quick Start
Note: You are required to have access to the amiga to develop on the backend so be sure to understand how to activate the amiga as well as have access from amiga docs. https://amiga.farm-ng.com/docs/ssh/
- The front end on the other hand can be developed without access to the amiga.
- 
The following is general steps to create a app on the amiga. Running a app is covered more on the backend portion. Furthermore refer to amiga docs on the creation of apps.
